...
- `/docs` - Further documentation on setup
- `/figures` - Contains script for figure plotting
- `/simulations` - Code to generate data for each figure
- `/utils` - Utility files for running code
